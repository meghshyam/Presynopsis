...
In case of multiplanar surfaces these problems worsen. In case of concave
...
%could synchronise the images stored on USB drive with the images streamed over
...
\subsection{Single Plane with Mutliple Visits}
