...
\caption{ (a) Pruned images from the quadcopter video using our
...
information, the
resulting 
images (or components) are disconnected instead of being mosaiced (unlike
AutoStitch). 
In contrast, in all cases, our algorithm successfully uses proximity
information which results in a reduced number of mini-panoramas. 
...
& \multicolumn{1}{p{8cm}|}{\centering Remarks}\\
\hline
